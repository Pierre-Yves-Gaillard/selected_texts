...
\nn\textbf{Theorem.} (i) \emph{There is a unique $\C[X]$-algebra morphism from $\mathcal O(U)$ to $\C[a]$. We denote this morphism by $f\mapsto f(a)$.}

\nn(ii) \emph{There is an $r>0$ and a neighborhood $N$ of $a$ in $A$ such that 
$$
...
%\nn$\bullet$ at writeLaTeX in tex and pdf format:\\\href{https://www.writelatex.com/245642vdhjtd}{https://www.writelatex.com/245642vdhjtd} 

\nn$\bullet$ at Google Drive in tex and pdf format: \href{http://goo.gl/sWG1la}{http://goo.gl/sWG1la}

\nn$\bullet$ at Mediafire in tex and pdf format: 

\href{https://www.mediafire.com/folder/2kgfet0by7ifv/WEBSITE}{https://www.mediafire.com/folder/2kgfet0by7ifv/WEBSITE} 
